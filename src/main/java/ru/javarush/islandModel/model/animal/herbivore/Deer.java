...
public class Deer extends Animal implements Herbivore {
    private static double weightAvg = Settings.getSettings().getWeightAvg().get(Deer.class);
    private static double dailyAllowance = Settings.getSettings().getDailyAllowance().get(Deer.class);
